...
function App() {
  ...
  const getApidata = async () => {
    const options = {
      ...
      headers: {
        'X-RapidAPI-Key': 'dc740737d4mshac5e674270f8a2ap122c4ejsn976211dad38b',
  ...
  return (
    ...
    <div className="container bg-gray-100">
      ...
      <a href='https://appopener.co.in/ig/8atgj29jc' target='_blank' rel='noreferrer' className='flex gap-2 flex-row justify-center items-center'>
        ...
        <h1 className='text-xl text-black font-semibold font-mono'>Coded by Vishal</h1>
      </a>
      <div className="content">
        ...
        {videoData && !error && <div className='flex flex-row flex-wrap gap-10 justify-between border-2 border-indigo-800 items-center w-10/12 p-5 m-5'>
